...
import world.tile.TileRegistry;
...
public class Tiles {
    private static int SIZE = 40; // Tile size in pixels
    private static int WIDTH = 128; // Number of tiles horizontally in the level
    private static int HEIGHT = 40; // Number of tiles vertically in the level
    ...
    public static void setSize(int size) { Tiles.SIZE = size; }
    public static int getWidth() { return WIDTH; }
    public static void setWidth(int width) { Tiles.WIDTH = width; }
    public static int getHeight() { return HEIGHT; }
    public static void setHeight(int height) { Tiles.HEIGHT = height; }
    public static int[][] getGrid() { return grid; }
    public static void setGrid(int[][] grid) { Tiles.grid = grid; }
    ...
    public static boolean isSolid(int tileId) {
        return TileRegistry.byId(tileId).isSolid();
    }

    public static boolean isSpike(int tileId) {
        return TileRegistry.byId(tileId).isSpike();
    }

    public static boolean isSpawn(int tileId) {
        return tileId == TileType.SPAWN.getId();
    }

    public static boolean isAir(int tileId) {
        return tileId == TileType.AIR.getId();
    }
